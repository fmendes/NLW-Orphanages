...
import mapMarkerImg from '../images/orphanIcon.png';
...
export default function OrphanageDetails() {
  ...
  function handleOpenGoogleMapRoutes( lat: number, long: number ) {
    ...
    <ScrollView style={styles.container}>
        ...
        <ScrollView horizontal pagingEnabled>
          { orphanage.images.map( image => {
            return (
              <Image key={image.id} 
                      style={styles.image} 
                      source={{ uri: `http://192.168.1.213:3333${image.url}` }} />
            );
          } ) }
        </ScrollView>
      </View>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={ () => handleOpenGoogleMapRoutes( orphanage.latitude, orphanage.longitude ) }
        ...
        <Text style={styles.title}>Instructions for visitation</Text>
        ...
        <View style={styles.scheduleContainer}>
          ...
          <View style={[styles.scheduleItem
            ...
            <Feather name="info" size={40} color={
              orphanage.open_on_weekends ? '#39CC83' : '#FF669D'
            } />
            <Text style={[styles.scheduleText
                      , orphanage.open_on_weekends ? styles.scheduleTextGreen : styles.scheduleTextRed ]}>
              { orphanage.open_on_weekends ? 'Open' : 'Closed' } on weekends
              </Text>
          </View>
        </View>
        ...
        <RectButton style={styles.contactButton} onPress={() => {}}>
          ...
          <Text style={styles.contactButtonText}>Contact orphanage</Text>
        </RectButton>
      </View>
    </ScrollView>
  )
